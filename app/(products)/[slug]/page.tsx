        ...
        <div className="min-h-screen w-full flex items-center justify-center px-2 lg:px-16 py-2 lg:py-4 font-mono bg-[#FDC161]">
            <div className="h-auto lg:h-[95dvh] w-full flex flex-col lg:flex-row rounded-2xl border-2 border-black overflow-hidden">
                ...
                <div className="order-3 lg:order-1 flex flex-col h-full lg:border-r-2 border-black w-full lg:w-[32%] min-w-0 bg-[#FDC161]">
                    {/* DESKTOP HEADER */}
                    <div className="hidden lg:flex flex-none flex-col items-center justify-center gap-2 p-2 lg:p-4 border-b-2 border-black text-center">
                ...
                <div className="order-2 lg:order-3 flex flex-col min-w-0 lg:min-w-[32%] min-h-0 bg-[#FDC161]">
                    ...
                    <div className="shrink-0 flex items-center justify-between px-4 py-2 text-lg border-b-2 border-black bg-[#FDC161]">
                        <button className="w-8 h-8 flex items-center justify-center group cursor-pointer">
                            <Image src="/minus.svg" alt="-" width={24} height={24} className="w-6 h-6" />
                        </button>
                        <span>1 CASE (12 CANS)</span>
                        <button className="w-8 h-8 flex items-center justify-center group cursor-pointer">
                            <Image src="/plus.svg" alt="+" width={24} height={24} className="w-6 h-6" />
                        </button>
                    </div>
                    ...
                    <div className="shrink-0 hidden lg:block bg-[#D48FCB]">
                        <button className="w-full bg-[#D48FCB] text-black font-bold text-lg lg:text-xl flex justify-between items-center px-4 lg:px-6 py-4 lg:py-6">
